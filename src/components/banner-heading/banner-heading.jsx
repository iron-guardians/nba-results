...
const Banner = () => {
  return (
    <div
      className="relative bg-gray-800 text-white pt-10 pb-12 px-10 shadow-inner"
      style={{
        boxShadow: "inset 0 6px 12px rgba(0, 0, 0, 0.7), inset 0 -6px 12px rgba(0, 0, 0, 0.7)",
        backgroundImage: "url('/images/court-banner.png')",
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="md:w-1/2 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            <span className="text-orange-500">Dunk</span>
            <span className="text-blue-400">Nation</span>
          </h1>
          <p className="text-gray-400 mb-6 text-lg">
            Where <span className="text-orange-500 font-bold">basketball</span>{" "}
          ...
          <div className="flex justify-center md:justify-start gap-4">
            <a
              href="#"
              className="bg-orange-500 hover:bg-orange-600 text-white hover:text-blue-200 font-semibold px-6 py-3 rounded transition duration-300"
            >
              REGISTER
            </a>
            {/* <a
